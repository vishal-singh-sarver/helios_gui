...
export const fetchStatusSuccess = (payload: RightPanelStatus): FetchStatusSuccessAction => ({
...
export const sseEvent = (payload: RightPanelStreamEvent): SseEventAction => ({
  type: SSE_EVENT,
  payload
})
