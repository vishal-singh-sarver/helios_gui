...
import type { CenterWorkspaceStatus } from './types'
...
export function* fetchStatusWorker(): Generator {
  try {
    const status = (yield call(
      api.get<CenterWorkspaceStatus>,
      '/api/status'
    )) as CenterWorkspaceStatus
...
export default function* centerWorkspaceSaga(): Generator {
