...
describe('CenterWorkspace actions', () => {
  ...
  it('sseEvent carries payload', () => {
    const payload: CenterWorkspaceStreamEvent = { type: 'ping', data: null, timestamp: 1 }
